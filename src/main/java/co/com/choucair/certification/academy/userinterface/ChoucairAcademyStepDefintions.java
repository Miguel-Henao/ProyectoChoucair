...
public class ChoucairAcademyStepDefintions {
    ...
    @Given("^than Miguel wants to learn automation at academy choecair$")
    public void thanMiguelWantsToLearnAutomationAtAcademyChoecair(List<AcademyChoucarData> academyChoucarData) throws Exception {
